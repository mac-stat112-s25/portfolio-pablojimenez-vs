...
```{r}
#| fig-cap: "Temperatures across Australian locations "

ggplot(weather, aes(y = temp3pm, x = temp9am, color = location)) +
  geom_point() +
  labs(x = "9am Temp (°C)", y = "3pm Temp (°C)", color = "Location")
```
...
#| fig-alt: "Density plots showing the distribution of 3pm temperatures for Hobart, Uluru, and Wollongong in Australia.The x-axis represents the 3pm temperature in degrees Celsius. Data source: https://mac-stat.github.io/data/weather_3_locations.csv"
...
It would have definetely changed their response due to the different interpretation they would get from the colors.
...
ggplot(weather, aes(y = temp3pm, x = temp9am, fill(maxtemp) )) + 
