...
It linked the information of the course to all the students_1 whose role is to retain all of the observations while enrollments only retained Stat and Geo

-   What, if anything, would change if we reversed the order of the data tables? Think about it, then try.

It would be interesting to retain the courses and not the students 
...
THeir role is to only retain specific enrollment info

-   What, if anything, would change if we reversed the order of the data tables? Think about it, then try.

It would have a different order in the column but essentially the same information
```{r}
enrollments_1 |> 
...
All of the information were retained in both
...
-   What did this do? What info would it give us? ONly C
